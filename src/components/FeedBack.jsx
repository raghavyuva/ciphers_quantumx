...
function FeedBack() {
    return (
        <div className='flex justify-center'>
            <div className="flex flex-col w-auto p-8 shadow-sm rounded-xl lg:p-12 dark:bg-gray-900 dark:text-gray-100">
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex flex-col w-full">
                        <textarea rows="3" placeholder="Message..." className="p-4 rounded-md resize-none border dark:text-gray-100 dark:bg-gray-900"></textarea>
